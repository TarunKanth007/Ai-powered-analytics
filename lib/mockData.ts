...
export const keyMetrics = {
  totalRevenue: {
    value: 145820,
    growth: 12.5,
    trend: 'up', // This will now be a plain string
  ...
  conversionRate: {
    value: 3.24,
    growth: -2.1,
    trend: 'down', // This will now be a plain string
    previousValue: 3.31,
    target: 3.5,
    industryAvg: 2.86
  },
...
export const addUserData = (type, data) => {
  if (type === 'revenue') {
    userAddedData.revenue.push(data);
  } else if (type === 'campaign') {
    userAddedData.campaigns.push(data);
  } else if (type === 'metrics') {
    userAddedData.metrics = { ...userAddedData.metrics, ...data };
  }
};

export const getUserData = () => userAddedData;

export const clearUserData = (type) => {
  if (type === 'revenue') {
